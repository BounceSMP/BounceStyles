        ...
        for(Types t : Types.values()) {
            ...
            if(file.exists()) {
                ...
                for(JsonElement element : jsonArray) {
                    ...
                    //Register
                    StyleItem newItem = t.baseClass.getDeclaredConstructor(String.class, ResourceLocation.class, ResourceLocation.class, ResourceLocation.class, HashMap.class).newInstance((name + "_" + t).toLowerCase(), modelID, textureID, animationID, animationMap);
