    ...
    public static class PresetEntry extends EntryListWidget.Entry<PresetEntry> {
        ...
        public boolean mouseClicked(double mouseX, double mouseY, int button) {
            if(this.isHovered) {
                ...
                BounceStylesNetwork.NETWORK.sendToServer(new EquipStyleC2S(StyleLoader.Category.Body, StyleLoader.getStyle(preset.headId())));
                BounceStylesNetwork.NETWORK.sendToServer(new EquipStyleC2S(StyleLoader.Category.Legs, StyleLoader.getStyle(preset.headId())));
                BounceStylesNetwork.NETWORK.sendToServer(new EquipStyleC2S(StyleLoader.Category.Feet, StyleLoader.getStyle(preset.headId())));
