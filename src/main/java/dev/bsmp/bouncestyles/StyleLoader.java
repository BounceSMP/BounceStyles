            ...
            if (item.has("slots")) {
                for (JsonElement e : item.getAsJsonArray("slots")) {
                    switch (e.getAsString().toLowerCase()) {
                        case "head": style.categories.add(Category.Head); break;
                        case "body": style.categories.add(Category.Body); break;
                        case "legs": style.categories.add(Category.Legs); break;
                        case "feet": style.categories.add(Category.Feet); break;
                    }
                }
            }
