...
public class StyleDataAttachment {
    ...
    public static void setEntityData(AttachmentHolder target, StyleData data) {
        //? if fabric {
    ...
    //~ if fabric 'AttachmentHolder' -> 'AttachmentTarget'
    public static StyleData getEntityData(AttachmentHolder target) {
        //? if fabric {
        /*return target.getAttached(BounceStylesFabric.STYLE_DATA_ATTACHMENT);
        *///? } else
